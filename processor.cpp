...
void interrupt_print()
{
    ...
    cout << "." << endl
         ...
         << "." << endl
         << "." << endl;
    cout << "Interrupt has been service" << endl;
}
        ...
        else if (RAM[i][0] == 'F')
        {
                              ...
                              // 1 - processor will not be handling interrupt
            {
                if (int_flag == 1) // pressed i for interrupt
                {
                    ...
                    PC[1] = '0';
                    PC[0] = 'F';
                    cout << " PC jump to location where Interrupt handling subroutine is written and Stack has the return address and R flag is set." << endl;
                    showContent();
